...
//      Postcondition: The sequence has been initialized as a copy of source sequence.
//      The sequence will hold the same items and have the same capacity as source.
//
